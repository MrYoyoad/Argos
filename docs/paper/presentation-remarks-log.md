...
| 189 | 15 (trio) | Replaced vitamin_d with hypertension (IS 4.5, WER 23%) — too optimistic, then replaced with street_photo (IS 2.9, WER 56%): "street photography" topic right but speaker names lost — proper near-miss | done |
