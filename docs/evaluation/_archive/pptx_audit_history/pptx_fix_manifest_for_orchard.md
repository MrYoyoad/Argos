...
- [OVERLAP] Shapes 'TextBox 6' & 'TextBox 12' overlap by 35% of smaller bbox (textA: "IS runs offline — no API, no G" / textB: "IS is 0.0–5.0 continuous from ")
- [OVERLAP] Shapes 'TextBox 9' & 'TextBox 15' overlap by 35% of smaller bbox (textA: "IS produces identical scores e" / textB: "12+ documented systematic bias")
- [OVERLAP] Shapes 'TextBox 12' & 'TextBox 17' overlap by 42% of smaller bbox (textA: "IS is 0.0–5.0 continuous from " / textB: "⑤ Decomposability")
- [OVERLAP] Shapes 'TextBox 15' & 'TextBox 17' overlap by 42% of smaller bbox (textA: "12+ documented systematic bias" / textB: "⑤ Decomposability")
- [OVERLAP] Shapes 'TextBox 18' & 'TextBox 19' overlap by 37% of smaller bbox (textA: "IS breaks into 6 named signals" / textB: "IS runs in production; LLM-as-")
- [OCCLUSION] Text shape 'TextBox 6' ("IS runs offline — no API, no GPU, no int…") is 110% covered by later shape(s).
- [OCCLUSION] Text shape 'TextBox 9' ("IS produces identical scores every time.…") is 110% covered by later shape(s).
- [OCCLUSION] Text shape 'TextBox 12' ("IS is 0.0–5.0 continuous from 6 signals.…") is 49% covered by later shape(s).
- [OCCLUSION] Text shape 'TextBox 15' ("12+ documented systematic biases in LLM …") is 49% covered by later shape(s).
- [OCCLUSION] Text shape 'TextBox 18' ("IS breaks into 6 named signals → diagnos…") is 37% covered by later shape(s).
...
- [OVERLAP] Shapes 'TextBox 7' & 'TextBox 8' overlap by 60% of smaller bbox (textA: "NIV-Y+P  (IS ≥ 2.00, determini" / textB: "NIV-Y (clearly conveyed): 23.9")
- [OVERLAP] Shapes 'TextBox 8' & 'TextBox 9' overlap by 79% of smaller bbox (textA: "NIV-Y (clearly conveyed): 23.9" / textB: "LLM Judge v3 Y+P: 71.08% (base")
- [OVERLAP] Shapes 'TextBox 9' & 'TextBox 18' overlap by 41% of smaller bbox (textA: "LLM Judge v3 Y+P: 71.08% (base" / textB: "Tier 5 Excellent ≥4.0")
...
- [OVERLAP] Shapes 'TextBox 14' & 'TextBox 15' overlap by 71% of smaller bbox (textA: "Recall of useful content  (FPR" / textB: "630 trusted segments  /  602 T")
- [OVERLAP] Shapes 'TextBox 15' & 'TextBox 16' overlap by 47% of smaller bbox (textA: "630 trusted segments  /  602 T" / textB: "Joint conf+beam-agreement band")
- [OCCLUSION] Text shape 'TextBox 5' ("What the model can produce on the 1,497-…") is 56% covered by later shape(s).
- [OCCLUSION] Text shape 'TextBox 7' ("NIV-Y+P  (IS ≥ 2.00, deterministic)…") is 75% covered by later shape(s).
- [OCCLUSION] Text shape 'TextBox 8' ("NIV-Y (clearly conveyed): 23.91%      Me…") is 68% covered by later shape(s).
...
- [OCCLUSION] Text shape 'TextBox 14' ("Recall of useful content  (FPR 5.6%)…") is 75% covered by later shape(s).
- [OCCLUSION] Text shape 'TextBox 15' ("630 trusted segments  /  602 TPs  /  28 …") is 47% covered by later shape(s).
- [OCCLUSION] Text shape 'TextBox 16' ("Joint conf+beam-agreement bands  •  cali…") is 55% covered by later shape(s).
...
- [OVERLAP] Shapes 'TextBox 8' & 'TextBox 9' overlap by 45% of smaller bbox (textA: "Joint-rule numbers above are f" / textB: "Green reliability is condition")
- [OCCLUSION] Text shape 'TextBox 3' ("P(correct | green) stratified by segment…") is 37% covered by later shape(s).
- [OCCLUSION] Text shape 'TextBox 5' ("Stratified P(green | bin)…") is 65% covered by later shape(s).
- [OCCLUSION] Text shape 'TextBox 8' ("Joint-rule numbers above are filtered to…") is 45% covered by later shape(s).
...
- [OVERLAP] Shapes 'TextBox 10' & 'TextBox 11' overlap by 78% of smaller bbox (textA: "[per-word colors load from the" / textB: "Most words green. The 'preside")
- [OCCLUSION] Text shape 'TextBox 10' ("[per-word colors load from the conf-only…") is 39% covered by later shape(s).
...
- [OVERLAP] Shapes 'TextBox 12' & 'TextBox 18' overlap by 15% of smaller bbox (textA: "IS is 0.0–5.0 continuous from " / textB: "IS breaks into 6 named signals")
- [OVERLAP] Shapes 'TextBox 15' & 'TextBox 18' overlap by 15% of smaller bbox (textA: "12+ documented systematic bias" / textB: "IS breaks into 6 named signals")
...
**Slide 36 — Where It Works — and How It Fails: Oracle vs Realistic**
- [OVERLAP] Shapes 'TextBox 7' & 'TextBox 9' overlap by 15% of smaller bbox (textA: "NIV-Y+P  (IS ≥ 2.00, determini" / textB: "LLM Judge v3 Y+P: 71.08% (base")
- [OVERLAP] Shapes 'TextBox 14' & 'TextBox 16' overlap by 15% of smaller bbox (textA: "Recall of useful content  (FPR" / textB: "Joint conf+beam-agreement band")
...
- [OVERLAP] Shapes 'TextBox 3' & 'TextBox 5' overlap by 30% of smaller bbox (textA: "P(correct | green) stratified " / textB: "Stratified P(green | bin)")
...
- [OVERLAP] Shapes 'TextBox 7' & 'TextBox 8' overlap by 6% of smaller bbox (textA: "• 62.5pp green→red spread in Y" / textB: "Per-word flag is genuine signa")
