...
- [LAYOUT] Shape 'Table 4' extends outside slide canvas (bbox left=0.60 top=2.00 right=13.70 bottom=4.75; canvas 13.33x7.50)

**Slide 60 — N-best Aggregation: v3 Judge Paired Tests**
- [LAYOUT] Shape 'Table 5' extends outside slide canvas (bbox left=7.30 top=2.05 right=13.70 bottom=4.55; canvas 13.33x7.50)

**Slide 63 — Demo: OK → Almost There → Hallucination**
- [ANIMATION] Animation references 2 non-existent shape id(s): ['10', '7']

**Slide 64 — Demo - Obama Trust Tier**
- [ANIMATION] Animation references 1 non-existent shape id(s): ['7']

**Slide 65 — Demo - Obama Salvage Tier (partial recovery)**
- [ANIMATION] Animation references 1 non-existent shape id(s): ['7']
...
- [STYLE] Body font 11pt below 12pt readability floor (shape 'TextBox 17', text "Tier 5 — Excellent (IS ≥ 4.0)…")
- [STYLE] Body font 11pt below 12pt readability floor (shape 'TextBox 19', text "291  (19.4%)…")
- [STYLE] Body font 11pt below 12pt readability floor (shape 'TextBox 20', text "Tier 4 — Good (3.0–3.99)…")
- [STYLE] Body font 11pt below 12pt readability floor (shape 'TextBox 22', text "324  (21.6%)…")
- [STYLE] Body font 11pt below 12pt readability floor (shape 'TextBox 23', text "Tier 3 — Fair (2.0–2.99)…")
- [STYLE] Body font 11pt below 12pt readability floor (shape 'TextBox 25', text "312  (20.8%)…")
- [STYLE] Body font 11pt below 12pt readability floor (shape 'TextBox 26', text "Tier 2 — Poor (1.0–1.99)…")
- [STYLE] Body font 11pt below 12pt readability floor (shape 'TextBox 28', text "329  (22.0%)…")
- [STYLE] Body font 11pt below 12pt readability floor (shape 'TextBox 29', text "Tier 1 — Failed (< 1.0)…")
- [STYLE] Body font 11pt below 12pt readability floor (shape 'TextBox 31', text "241  (16.1%)…")
...
- [STYLE] Body font 9pt below 12pt readability floor (shape 'TextBox 6', text "IS 1.29  |  Prob 0.55…")
...
- [STYLE] Body font 9pt below 12pt readability floor (shape 'TextBox 15', text "IS 2.18  |  Prob 0.90…")
...
- [STYLE] Body font 9pt below 12pt readability floor (shape 'TextBox 24', text "IS 2.55  |  Prob 0.95…")
...
- [STYLE] Body font 9pt below 12pt readability floor (shape 'TextBox 6', text "IS 2.75  |  Prob 0.90…")
- [STYLE] Body font 9pt below 12pt readability floor (shape 'TextBox 7', text "Reference:…")
...
- [STYLE] Body font 9pt below 12pt readability floor (shape 'TextBox 15', text "IS 2.86  |  Prob 0.90…")
- [STYLE] Body font 9pt below 12pt readability floor (shape 'TextBox 16', text "Reference:…")
...
- [STYLE] Body font 9pt below 12pt readability floor (shape 'TextBox 24', text "IS 2.07  |  Prob 0.80…")
- [STYLE] Body font 9pt below 12pt readability floor (shape 'TextBox 25', text "Reference:…")
...
**Slide 59 — Phase 2: Exploit All 20 Hypotheses**
...
- [STYLE] Body font 10pt below 12pt readability floor (shape 'TextBox 7', text "Audit keys: judge_v3_*, mcnemar_yp_p_{mb…")
- [OVERLAP] Shapes 'TextBox 6' & 'TextBox 7' overlap by 45% of smaller bbox (textA: "• Y verdict tied across all me" / textB: "Audit keys: judge_v3_*, mcnema")

**Slide 61 — Why MBR Won the Default-Display Slot**
- [STYLE] Body font 10pt below 12pt readability floor (shape 'TextBox 8', text "Wired via make_report.py --display-metho…")
- [OVERLAP] Shapes 'TextBox 7' & 'TextBox 8' overlap by 95% of smaller bbox (textA: "• MBR mean per-word conf 0.867" / textB: "Wired via make_report.py --dis")
...
- [OVERLAP] Shapes 'TextBox 11' & 'TextBox 13' overlap by 72% of smaller bbox (textA: "Research observation: 27/29 pe" / textB: "62")
...
- [STYLE] Body font 10pt below 12pt readability floor (shape 'TextBox 7', text "REFERENCE…")
- [STYLE] Body font 10pt below 12pt readability floor (shape 'TextBox 9', text "HYPOTHESIS  (per-word band observation)…")
- [OVERLAP] Shapes 'TextBox 11' & 'TextBox 13' overlap by 72% of smaller bbox (textA: "Research observation: most wor" / textB: "63")
...
- [STYLE] Body font 10pt below 12pt readability floor (shape 'TextBox 7', text "REFERENCE…")
- [STYLE] Body font 10pt below 12pt readability floor (shape 'TextBox 9', text "HYPOTHESIS  (per-word band observation)…")
- [OVERLAP] Shapes 'TextBox 11' & 'TextBox 13' overlap by 72% of smaller bbox (textA: "Research observation: the mode" / textB: "64")
...
- [STYLE] Body font 10pt below 12pt readability floor (shape 'TextBox 7', text "REFERENCE…")
- [STYLE] Body font 10pt below 12pt readability floor (shape 'TextBox 9', text "HYPOTHESIS  (per-word band observation)…")
- [OVERLAP] Shapes 'TextBox 11' & 'TextBox 13' overlap by 72% of smaller bbox (textA: "Research observation: the enti" / textB: "65")
- [VIDEO] Embedded media (media2.mp4, 1375351 bytes) does not match any file in 06_demo_videos/ by size — likely orphaned or renamed source.
- [VIDEO] Embedded media (media2.mp4, 1375351 bytes) does not match any file in 06_demo_videos/ by size — likely orphaned or renamed source.
...
- [STYLE] Body font 10pt below 12pt readability floor (shape 'TextBox 7', text "REFERENCE…")
- [STYLE] Body font 10pt below 12pt readability floor (shape 'TextBox 9', text "HYPOTHESIS  (per-word band observation)…")
- [OVERLAP] Shapes 'TextBox 11' & 'TextBox 13' overlap by 72% of smaller bbox (textA: "Research observation: argument" / textB: "66")
- [VIDEO] Embedded media (media4.mp4, 2540214 bytes) does not match any file in 06_demo_videos/ by size — likely orphaned or renamed source.
- [VIDEO] Embedded media (media4.mp4, 2540214 bytes) does not match any file in 06_demo_videos/ by size — likely orphaned or renamed source.
...
- [OVERLAP] Shapes 'TextBox 9' & 'TextBox 11' overlap by 72% of smaller bbox (textA: "Source: docs/evaluation/is_pca" / textB: "A5")
...
- [STYLE] Body font 9pt below 12pt readability floor (shape 'TextBox 11', text "A9…")
...
- [OVERLAP] Shapes 'TextBox 7' & 'TextBox 9' overlap by 92% of smaller bbox (textA: "Caveat: identical-text drift v" / textB: "A10")
...
**Slide 37 — Where the System Works: Oracle vs Realistic**
- [LAYOUT] Shape 'TextBox 28' within 0.1in of slide edge (left=11.30, top=5.90, right_gap=0.03, bot_gap=1.28)
- [BRAND] No corner logo (~0.35in) detected; expected per add_logo helper.
...
**Slide 48 — Phase 1: Confidence Scoring — Surface the Good 65%**
- [BRAND] No corner logo (~0.35in) detected; expected per add_logo helper.
- [NOTES] Notes cite 2 numbers but lack any source reference (.md/.csv path).
...
**Slide 70 — Starting from 61.6%, Not 25%**
- [BRAND] No corner logo (~0.35in) detected; expected per add_logo helper.
- [NOTES] Notes cite 7 numbers but lack any source reference (.md/.csv path).
