...
- **Built**: 2026-08-07 · image ID `268f5765d4c0` (60.9 GB) · tag `vsp-llm-pipeline:client-build-004` · git tag `client-build-004` @ `afe1f69` · tarball `vsp-image-client-build-004-20260807.tar.zst` (41,183,257,695 bytes, sha256 `9b581645a4591dfa8d58890d54ce6cb746f74327901d03ee6e2be13d46dd7118`) — **uploaded + size-verified at `s3://yoad-vsp-transfer/vsp/` 2026-08-07** with `.sha256` sidecar; 10× 4 GB `part_*` splits kept local for USB staging.
