...
BORROWED_SLIDES = {
    # Round 5.8: next_milestone slide added in §What's Next between
    # arabic_high_level and partnership_ask. Only slide_thank_you (last)
    # shifts; all earlier borrows stay at the same indices.
