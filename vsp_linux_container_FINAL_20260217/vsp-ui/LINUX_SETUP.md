...
For easy one-click access to the VSP Pipeline UI, you can install a desktop icon.
...
Then double-click the icon on your desktop to:
- Start the server (or detect if already running)
- Open your browser to the UI
- Open the input folder for dragging videos

For detailed instructions and troubleshooting, see [DESKTOP_ICON_INSTALL.md](DESKTOP_ICON_INSTALL.md).
